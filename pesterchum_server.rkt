...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname pesterchum_server) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
